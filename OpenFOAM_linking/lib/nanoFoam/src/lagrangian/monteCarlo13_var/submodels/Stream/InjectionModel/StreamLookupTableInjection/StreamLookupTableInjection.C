...
#include "StreamLookupTableInjection.H"
#include "scalarIOList.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CloudType>
Foam::StreamLookupTableInjection<CloudType>::StreamLookupTableInjection
(
...
Foam::StreamLookupTableInjection<CloudType>::StreamLookupTableInjection
(
    const StreamLookupTableInjection<CloudType>& im
)
:
...
template<class CloudType>
void Foam::StreamLookupTableInjection<CloudType>::updateMesh()
{
    // Set/cache the injector cells
    forAll(injectors_, i)
    {
...
template<class CloudType>
Foam::scalar Foam::StreamLookupTableInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
Foam::label Foam::StreamLookupTableInjection<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::StreamLookupTableInjection<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::StreamLookupTableInjection<CloudType>::setPositionAndCell
(
    const label parcelI,
...
template<class CloudType>
void Foam::StreamLookupTableInjection<CloudType>::setProperties
(
    const label parcelI,
    const label nParcels,
    const scalar,
...
template<class CloudType>
bool Foam::StreamLookupTableInjection<CloudType>::fullyDescribed() const
{
    return true;
}
...
template<class CloudType>
bool Foam::StreamLookupTableInjection<CloudType>::validInjection
(
    const label
)
{

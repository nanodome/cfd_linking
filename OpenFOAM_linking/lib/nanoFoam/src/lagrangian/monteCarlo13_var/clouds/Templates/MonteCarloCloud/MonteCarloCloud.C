...
void Foam::MonteCarloCloud<CloudType>::setModels()
{
    dispersionModel_.reset
    (
        DispersionModel<MonteCarloCloud<CloudType> >::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        PatchInteractionModel<MonteCarloCloud<CloudType> >::New
        (
            subModelProperties_,
            *this
        ).ptr()
    ...
    (
        SurfaceFilmModel<MonteCarloCloud<CloudType> >::New
        (
            subModelProperties_,
            *this
        ).ptr()
...
void Foam::MonteCarloCloud<CloudType>::solve(TrackData& td)
{
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::buildCellOccupancy()
{
    ...
    forAllIter(typename MonteCarloCloud<CloudType>, *this, iter)
    {
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::updateCellOccupancy()
{
...
template<class CloudType>
template<class TrackData>
void Foam::MonteCarloCloud<CloudType>::evolveCloud(TrackData& td)
{
    if (solution_.coupled())
    {
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::postEvolve()
{
    Info<< endl;
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::cloudReset(MonteCarloCloud<CloudType>& c)
{
...
template<class CloudType>
Foam::MonteCarloCloud<CloudType>::MonteCarloCloud
(
    ...
    //- modified by Patrick
    //const volScalarField& Mf, 
    //const volScalarField& epsilon,
    //const volScalarField& k, 
    //const volScalarField& YTTIP,
    //- added by Patrick
...
:
    ...
    (
        *this,
        particleProperties_.subOrEmptyDict("XMLSampling"),
        solution_.active()
    ),
    injectors_
    (
...
(
    const fvMesh& mesh,
    const word& name,
    const MonteCarloCloud<CloudType>& c
)
:
...
template<class CloudType>
bool Foam::MonteCarloCloud<CloudType>::hasWallImpactDistance() const
{
    return true;
}
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::setParcelThermoProperties
(
    parcelType& parcel,
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::checkParcelProperties
(
    parcelType& parcel,
    const scalar lagrangianDt,
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::storeState()
{
    cloudCopyPtr_.reset
    (
        static_cast<MonteCarloCloud<CloudType>*>
        (
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::restoreState()
{
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::resetSourceTerms()
{
    UTrans().field() = vector::zero;
    TTrans().field() = 0.0;
    nParticleTrans().field() = 0.0;  
    rhopTrans().field() = 0.0; 
    UCoeff().field() = 0.0;
}
...
template<class CloudType>
template<class Type>
void Foam::MonteCarloCloud<CloudType>::relax
(
...
template<class CloudType>
template<class Type>
void Foam::MonteCarloCloud<CloudType>::scale
(
    DimensionedField<Type, volMesh>& field,
    const word& name
) const
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::relaxSources
(
    const MonteCarloCloud<CloudType>& cloudOldTime
)
{
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::scaleSources()
{
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::preEvolve()
{
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::evolve()
{
    if (solution_.canEvolve())
    {
        typename parcelType::template
            TrackingData<MonteCarloCloud<CloudType> > td(*this);
...
template<class CloudType>
template<class TrackData>
void Foam::MonteCarloCloud<CloudType>::motion(TrackData& td)
{
    td.part() = TrackData::tpLinearTrack;
    CloudType::move(td,  solution_.trackTime());
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::patchData
(
    const parcelType& p,
    const polyPatch& pp,
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::updateMesh()
{
    updateCellOccupancy();
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::autoMap(const mapPolyMesh& mapper)
{
    typedef typename particle::TrackingData<MonteCarloCloud<CloudType> > tdType;
...
template<class CloudType>
void Foam::MonteCarloCloud<CloudType>::info()
{
